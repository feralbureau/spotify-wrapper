...
// NewLogin creates a Login initialized with the provided configuration, password, and identifier.
// It also sets cfg.Client.FailException to wrap client errors as a LoginError and returns the constructed *Login.
