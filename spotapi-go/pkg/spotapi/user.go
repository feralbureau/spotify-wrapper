...
// NewUser creates a User backed by the provided authorized Login.
// It returns an error if l is not authorized; on success the returned User has Login set and internal caches empty.
