...
// NewSong creates a Song configured with the given playlist and an underlying BaseClient.
// If playlist is non-nil, NewSong uses the playlist's configured HTTP client; otherwise it uses the provided client. The returned Song has Playlist set to the provided playlist and Base set to the constructed BaseClient.
