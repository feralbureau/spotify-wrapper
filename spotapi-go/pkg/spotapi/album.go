...
// NewPublicAlbum creates a PublicAlbum for the given album identifier or Spotify album URL.
// If the input contains "album/" the trailing segment is used as the album ID; the returned PublicAlbum has its Base client initialized with the provided HTTP client and language and its AlbumLink set to the corresponding open.spotify.com album URL.
